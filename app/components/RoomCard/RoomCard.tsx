...
const RoomCard: FC<Props> = (props) => {
  ...
  if (isDesktop) {
    return (
      <section className='body-font w-80 transition-all duration-100 hover:scale-[1.01]'>
        {!isBooked ? (
          <div className='group mx-5 my-10 gap-5 rounded-[calc(1rem-1px)] bg-gradient-to-b from-blue-300 to-pink-300 p-[2px] shadow-2xl hover:from-pink-300 hover:to-blue-300 hover:ring hover:ring-orange-400 hover:ring-offset-2 dark:from-blue-800 dark:to-purple-800 '>
            <div className='w-ful relative h-full rounded-lg bg-gray-50'>
              ...
              <div className='absolute -right-2 -top-2 z-50 aspect-square w-20 overflow-hidden rounded-sm'>
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  <DialogTrigger asChild>
                    <div className='absolute bottom-0 right-0 block w-square-diagonal origin-bottom-right rotate-45 cursor-pointer bg-pink-300 py-1.5  text-center text-xs font-semibold uppercase tracking-wider text-black shadow-sm shadow-tertiary-primary text-shadow-lg hover:bg-tertiary-primary hover:text-white'>
              ...
              <div className='p-6'>
                <h1 className='title-font mb-3 text-lg font-medium text-gray-900 shadow-tertiary-primary text-shadow-lg'>
                  {name}
                </h1>
                ...
                <div className='flex flex-wrap items-center '>
                  <Link
                    className='scale-animation-small inline-flex items-center text-sky-500 shadow-tertiary-primary text-shadow-lg md:mb-2 lg:mb-0'
          ...
          <div className='mx-5 my-10 gap-5 rounded-[calc(1rem-1px)] bg-gradient-to-b from-blue-300 to-pink-300 p-[2px] shadow-2xl hover:from-pink-300 hover:to-blue-300 hover:ring hover:ring-orange-400 hover:ring-offset-2 group-hover:blur-sm dark:from-blue-800 dark:to-purple-800 '>
            <div className='w-ful relative h-full rounded-lg bg-gray-50'>
              ...
              {/* <!-- Top Right --> */}
              {/* <!-- if want to move ribbon to center or move to edge, just change  w-36 --> */}
              <div className='absolute -right-2 -top-2 z-50 aspect-square w-20 overflow-hidden rounded-lg'>
                ...
                <Link
                  href='#'
                  className='absolute bottom-0 right-0 block w-square-diagonal origin-bottom-right rotate-45 bg-amber-300 py-1.5 text-center text-xs font-semibold uppercase tracking-wider text-amber-800 shadow-sm shadow-tertiary-primary text-shadow-lg hover:bg-yellow-300'
                >
                  {isBooked ? 'Booked' : 'Book Now'}
                </Link>
              </div>
  ...
  return (
    <section className='body-font w-80 text-gray-600 transition-all duration-100 hover:scale-[1.01]'>
      {!isBooked ? (
            ...
            <div className='absolute -right-2 -top-2 z-50 aspect-square w-20 overflow-hidden rounded-sm'>
              ...
              <Drawer open={open} onOpenChange={setOpen}>
                <DrawerTrigger asChild>
                  <div className='absolute bottom-0 right-0 block w-square-diagonal origin-bottom-right rotate-45 cursor-pointer bg-pink-300 py-1.5 text-center text-xs font-semibold uppercase tracking-wider text-pink-800 shadow-sm shadow-tertiary-primary text-shadow-lg hover:bg-sky-300'>
                    {isBooked ? 'Booked' : 'Book Now'}
                  </div>
                </DrawerTrigger>
                <DrawerContent>
