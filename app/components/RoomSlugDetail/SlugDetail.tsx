...
function SlugDetail({ room }: Readonly<SlugProps>) {
	...
	// Define the function outside of the component or use useCallback to memoize it
	...
	if (isDesktop) {
		return (
			<section className="px-4 py-6 sm:p-6 md:px-8 md:py-10" ref={ref}>
				...
				>
					{isInView ? <MemoizedBottomBarBooking /> : null}
				</div>
						...
						<Dialog open={open} onOpenChange={handleOpenChange}>
							...
							<DialogContent className="sm:max-w-[425px]">
								<DialogHeader>
									...
									<DialogDescription>
										Khi bạn đã sẵn sàng đặt phòng biệt thự này, vui lòng điền
										vào form dưới đây.
									</DialogDescription>
								</DialogHeader>
