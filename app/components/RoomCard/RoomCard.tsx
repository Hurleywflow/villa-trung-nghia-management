					...
					<div className="group  rounded-[calc(1rem-1px)] bg-gradient-to-b from-blue-300 to-pink-300 p-[2px] shadow-2xl hover:from-pink-300 hover:to-blue-300 hover:ring hover:ring-tertiary-primary hover:ring-offset-2 dark:from-blue-800 dark:to-purple-800 ">
						<div className="w-ful relative h-full rounded-lg bg-gray-50">
							...
							<div className="absolute -right-2 -top-2 z-40 aspect-square w-24 overflow-hidden rounded-sm">
								<div className="absolute left-0 top-0 h-2 w-2 bg-orange-800"></div>
								<div className="absolute bottom-0 right-0 h-2 w-2 bg-orange-800"></div>
								<Dialog open={open} onOpenChange={setOpen}>
									<DialogTrigger asChild>
										<div className="absolute bottom-0 right-0 block w-square-diagonal origin-bottom-right rotate-45 cursor-pointer bg-orange-500 py-1.5  text-center text-sm font-semibold uppercase tracking-wider text-slate-200 shadow-sm shadow-tertiary-primary text-shadow-lg hover:bg-tertiary-primary hover:text-white">
							...
							<Link href={`/rooms/${slug.current}`}>
								...
								<div className="p-1">
									...
									<pre className="line-clamp-3 text-[0.8rem]">{description}</pre>
						...
						<div className="absolute -right-2 -top-2 z-40 aspect-square w-24 overflow-hidden rounded-sm">
							...
							>
								<DrawerTrigger asChild>
									<div className="absolute bottom-0 right-0 block w-square-diagonal origin-bottom-right rotate-45 cursor-pointer bg-orange-500 py-1.5 text-center text-sm font-semibold uppercase tracking-wider text-slate-200 shadow-sm shadow-tertiary-primary text-shadow-lg hover:bg-tertiary-primary">
										{isBooked ? 'Booked' : 'Book Now'}
									</div>
								</DrawerTrigger>
								<DrawerContent>
