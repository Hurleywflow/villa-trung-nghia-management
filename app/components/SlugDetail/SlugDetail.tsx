    ...
    return (
      <section className='px-4 py-6 sm:p-6 md:px-8 md:py-10'>
        <div className='mx-auto grid max-w-6xl grid-cols-1 lg:max-w-7xl lg:grid-cols-2 lg:gap-x-20'>
          ...
          <p className='col-start-1 mt-4 text-base leading-6 dark:text-slate-400 sm:col-span-2 lg:col-span-1 lg:row-start-4 lg:mt-6'>
            {room.description}
          </p>
        </div>
      </section>
    ...
    <section className='px-4 py-6 sm:p-6 md:px-8 md:py-10'>
      <div className='mx-auto grid max-w-6xl grid-cols-1 lg:max-w-7xl lg:grid-cols-2 lg:gap-x-20'>
        ...
        <div className='col-start-1 col-end-3 row-start-1 grid gap-4 sm:mb-6 sm:grid-cols-4 lg:col-start-2 lg:row-span-6 lg:row-end-6 lg:mb-0 lg:gap-6'>
          ...
          {room.images.map((image, index) => (
            <div className='relative hidden h-52 w-full overflow-hidden rounded-lg sm:col-span-2 sm:block md:col-span-1 lg:col-span-2 lg:row-start-2 lg:h-32'>
              <Image
                key={index}
                alt={room.name}
                src={urlFor(image).url()}
