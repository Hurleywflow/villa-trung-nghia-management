...
const Card = ({ i, src, title, color, progress, range, targetScale }) => {
	...
	return (
		...
		>
			...
			>
				<div
					className="h-full  items-center justify-center gap-5 rounded-lg ring-2  ring-tertiary-primary ring-offset-2"
					// initial={{
					//   opacity: 0.3,
					// }}
					// whileInView={{
				...
				>
					<div className="relative h-full w-full overflow-hidden rounded-xl shadow-2xl ">
						<Image
							...
							alt={title}
							fill
							sizes="(max-width: 768px) 80vw, (max-width: 1024px) 80vw, 80vw"
